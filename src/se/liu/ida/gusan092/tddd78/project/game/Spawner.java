...
public class Spawner
{
    ...
    private int roadCounter = Game.HEIGHT * 2 - 18;
	...
	if (spawnCounter == 0) {
		...
		if (oneTo(20)) {
			...
			case 0:
			    ...
			    break;
			case 1:
			    if (oneTo(2)) handler.add(new Container(random.nextInt(Game.WIDTH - Container.SIZE), handler, PowerUpId.UNSTOPPABLE));
		...
		if (oneTo(20)) handler.add(new Container(random.nextInt(Game.WIDTH - Container.SIZE), handler, PowerUpId.AMMO));
	    }
	    spawnCounter = 60;
	}else spawnCounter--;
    }
